...
functions.http('updateCustomisation', (req, res) => {
    ...
    cors(req, res, async () => {
        ...
        try {
            ...
            if (!applicationName || !imageUrl) {
                return res.status(400).send("applicationName und imageUrl sind erforderlich");
            }
            ...
            // Aktualisierung der customisation Daten
             await docRef.update({
                customisation: {
            ...
            res.send("Customisation erfolgreich aktualisiert");
        } catch (error) {
